  ...
  :cljsbuild {:builds
              [#_{:id "devcards-test"
               ...
               {:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "cas.core/on-js-reload"
                ...
                :compiler {:main cas.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/cas.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/cas.js"
                           :main cas.core
